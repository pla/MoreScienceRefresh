...
--------------------------------------------------------------------------------
  ...
  researchTechnology("efficiency-module")
...
--------------------------------------------------------------------------------
  ...
  researchTechnology("efficiency-module-3")
...
--------------------------------------------------------------------------------
  ...
  researchTechnology("fission-reactor-equipment")
