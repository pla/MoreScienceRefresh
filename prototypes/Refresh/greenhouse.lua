...
greenhouse.graphics_set = {
  animation = {
    layers = {
      {
        filename = "__MoreScienceRefresh__/graphics/Refresh/greenhouse/greenhouse-hr-shadow.png",
        priority = "high",
        size = { 700, 500 },
        shift = { 0, 0 },
        scale = 0.5,
      ...
      },
      {
        ...
        stripes = {
          {
            filename = "__MoreScienceRefresh__/graphics/Refresh/greenhouse/greenhouse-hr-animation-1.png",
            width_in_frames = 8,
            height_in_frames = 8,
          },
          {
            filename = "__MoreScienceRefresh__/graphics/Refresh/greenhouse/greenhouse-hr-animation-2.png",
            width_in_frames = 8,
            height_in_frames = 8,
          },
        },
  ...
  working_visualisations = {
    {
      ...
      animation = {
        ...
        stripes = {
          {
            filename = "__MoreScienceRefresh__/graphics/Refresh/greenhouse/greenhouse-hr-emission-1.png",
            width_in_frames = 8,
            height_in_frames = 8,
          },
          {
            filename = "__MoreScienceRefresh__/graphics/Refresh/greenhouse/greenhouse-hr-emission-2.png",
            width_in_frames = 8,
            height_in_frames = 8,
          },
        },
