...
grinder_item.icon = "__MoreScienceRefresh__/graphics/Refresh/grinder/grinder-icon.png"
...
grinder.graphics_set = {
  animation = {
    layers = {
      {
        filename = "__MoreScienceRefresh__/graphics/Refresh/grinder/grinder-hr-shadow.png",
        priority = "high",
        size = { 1200, 700 },
        shift = { 0, -0.5 },
        scale = 0.5,
      ...
      },
      {
        ...
        stripes = {
          {
            filename = "__MoreScienceRefresh__/graphics/Refresh/grinder/grinder-hr-animation-1.png",
            width_in_frames = 8,
            height_in_frames = 8,
          },
          {
            filename = "__MoreScienceRefresh__/graphics/Refresh/grinder/grinder-hr-animation-2.png",
            width_in_frames = 8,
            height_in_frames = 2,
          },
        },
  ...
  working_visualisations = {
    {
      ...
      animation = {
        ...
        stripes = {
          {
            filename = "__MoreScienceRefresh__/graphics/Refresh/grinder/grinder-hr-emission-1.png",
            width_in_frames = 8,
            height_in_frames = 8,
          },
          {
            filename = "__MoreScienceRefresh__/graphics/Refresh/grinder/grinder-hr-emission-2.png",
            width_in_frames = 8,
            height_in_frames = 2,
          },
        },
