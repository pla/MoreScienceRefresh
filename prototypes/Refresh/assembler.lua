...
assembler.graphics_set = {
  animation = {
    layers = {
      {
        filename = "__MoreScienceRefresh__/graphics/Refresh/assembler/assembler-hr-shadow.png",
        priority = "high",
        size = { 520, 500 },
        shift = { 0, 0 },
        scale = 0.5,
      ...
      },
      {
        ...
        stripes = {
          {
            filename = "__MoreScienceRefresh__/graphics/Refresh/assembler/assembler-hr-animation-1.png",
            width_in_frames = 8,
            height_in_frames = 8,
          },
          {
            filename = "__MoreScienceRefresh__/graphics/Refresh/assembler/assembler-hr-animation-2.png",
            width_in_frames = 8,
            height_in_frames = 5,
          },
        },
  ...
  working_visualisations = {
    {
      ...
      animation = {
        ...
        stripes = {
          {
            filename = "__MoreScienceRefresh__/graphics/Refresh/assembler/assembler-hr-emission-1.png",
            width_in_frames = 8,
            height_in_frames = 8,
          },
          {
            filename = "__MoreScienceRefresh__/graphics/Refresh/assembler/assembler-hr-emission-2.png",
            width_in_frames = 8,
            height_in_frames = 5,
          },
        },
