...
thermalPlant_item.icon = "__MoreScienceRefresh__/graphics/Refresh/thermal-plant/thermal-plant-icon.png"
...
thermalPlant.graphics_set = {
  animation = {
    layers = {
      {
        filename = "__MoreScienceRefresh__/graphics/Refresh/thermal-plant/thermal-plant-hr-shadow.png",
        priority = "high",
        size = { 900, 500 },
        shift = { 0, -0.5 },
        scale = 0.5,
      ...
      },
      {
        ...
        stripes = {
          {
            filename = "__MoreScienceRefresh__/graphics/Refresh/thermal-plant/thermal-plant-hr-animation-1.png",
            width_in_frames = 8,
            height_in_frames = 8,
          },
          {
            filename = "__MoreScienceRefresh__/graphics/Refresh/thermal-plant/thermal-plant-hr-animation-2.png",
            width_in_frames = 8,
            height_in_frames = 2,
          },
        },
  ...
  working_visualisations = {
    {
      ...
      animation = {
        ...
        stripes = {
          {
            filename = "__MoreScienceRefresh__/graphics/Refresh/thermal-plant/thermal-plant-hr-emission-1.png",
            width_in_frames = 8,
            height_in_frames = 8,
          },
          {
            filename = "__MoreScienceRefresh__/graphics/Refresh/thermal-plant/thermal-plant-hr-emission-2.png",
            width_in_frames = 8,
            height_in_frames = 2,
          },
        },
