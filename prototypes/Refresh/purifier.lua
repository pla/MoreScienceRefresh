...
purifier_item.icon = "__MoreScienceRefresh__/graphics/Refresh/purifier/purifier-icon.png"
...
purifier.graphics_set = {
  animation = {
    layers = {
      {
        filename = "__MoreScienceRefresh__/graphics/Refresh/purifier/purifier-hr-shadow.png",
        priority = "high",
        size = { 600, 400 },
        shift = { 0, -0.5 },
        scale = 0.5,
      ...
      {
        filename = "__MoreScienceRefresh__/graphics/Refresh/purifier/purifier-hr-animation.png",
        size = { 320, 370 },
        shift = { 0, -0.5 },
        scale = 0.5,
        line_length = 8,
  ...
  --     fadeout = true,
  --     animation = {
  --       filename = "__MoreScienceRefresh__/graphics/Refresh/purifier/chemical-stager-hr-emission-1.png",
  --       priority = "high",
  --       size = { 400, 400 },
  --       shift = { 0, 0 },
  --       line_length = 8,
