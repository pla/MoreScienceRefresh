...
lumberMill_item.icon = "__MoreScienceRefresh__/graphics/Refresh/lumber-mill/lumber-mill-icon.png"
  ...
  animation = {
    layers = {
      ...
      },
      {
        ...
        stripes = {
          {
            filename = "__MoreScienceRefresh__/graphics/Refresh/lumber-mill/lumber-mill-hr-animation-1.png",
            width_in_frames = 8,
            height_in_frames = 8,
          },
          {
            filename = "__MoreScienceRefresh__/graphics/Refresh/lumber-mill/lumber-mill-hr-animation-2.png",
            width_in_frames = 8,
            height_in_frames = 2,
          },
        },
  ...
  working_visualisations = {
    {
      ...
      animation = {
        ...
        stripes = {
          {
            filename = "__MoreScienceRefresh__/graphics/Refresh/lumber-mill/lumber-mill-hr-emission-1.png",
            width_in_frames = 8,
            height_in_frames = 8,
          },
          {
            filename = "__MoreScienceRefresh__/graphics/Refresh/lumber-mill/lumber-mill-hr-emission-2.png",
            width_in_frames = 8,
            height_in_frames = 2,
          },
        },
