...
convector_item.icon = "__MoreScienceRefresh__/graphics/Refresh/convector/convector-icon.png"
...
convector.graphics_set = {
  animation = {
    layers = {
      {
        filename = "__MoreScienceRefresh__/graphics/Refresh/convector/convector-hr-shadow.png",
        priority = "high",
        size = { 600, 500 },
        shift = { 0, 0 },
        scale = 0.5,
      ...
      },
      {
        ...
        stripes = {
          {
            filename = "__MoreScienceRefresh__/graphics/Refresh/convector/convector-hr-animation-1.png",
            width_in_frames = 8,
            height_in_frames = 8,
          },
          {
            filename = "__MoreScienceRefresh__/graphics/Refresh/convector/convector-hr-animation-2.png",
            width_in_frames = 8,
            height_in_frames = 2,
          },
        },
  ...
  working_visualisations = {
    {
      ...
      animation = {
        ...
        stripes = {
          {
            filename = "__MoreScienceRefresh__/graphics/Refresh/convector/convector-hr-emission-1.png",
            width_in_frames = 8,
            height_in_frames = 8,
          },
          {
            filename = "__MoreScienceRefresh__/graphics/Refresh/convector/convector-hr-emission-2.png",
            width_in_frames = 8,
            height_in_frames = 2,
          },
        },
