...
chemicalStager_item.icon = "__MoreScienceRefresh__/graphics/Refresh/chemical-stager/chemical-stager-icon.png"
...
chemicalStager.graphics_set = {
  animation = {
    layers = {
      {
        filename = "__MoreScienceRefresh__/graphics/Refresh/chemical-stager/chemical-stager-hr-shadow.png",
        priority = "high",
        size = { 800, 600 },
        shift = { 0, -0.3 },
        scale = 0.5,
      ...
      {
        filename = "__MoreScienceRefresh__/graphics/Refresh/chemical-stager/chemical-stager-hr-animation-1.png",
        size = { 400, 400 },
        shift = { 0, -0.3 },
        scale = 0.5,
        line_length = 8,
  ...
  working_visualisations = {
    {
      fadeout = true,
      animation = {
        filename = "__MoreScienceRefresh__/graphics/Refresh/chemical-stager/chemical-stager-hr-emission-1.png",
        priority = "high",
        size = { 400, 400 },
        shift = { 0, -0.3 },
        line_length = 8,
