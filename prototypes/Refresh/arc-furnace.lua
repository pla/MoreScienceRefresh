...
arcFurnace.graphics_set = {
  animation = {
    layers = {
      {
        filename = "__MoreScienceRefresh__/graphics/Refresh/arc-furnace/arc-furnace-hr-shadow.png",
        priority = "high",
        size = { 600, 400 },
        shift = { 0, 0 },
        scale = 0.5,
      ...
      {
        filename = "__MoreScienceRefresh__/graphics/Refresh/arc-furnace/arc-furnace-hr-animation-1.png",
        size = { 320, 320 },
        shift = { 0, 0 },
        scale = 0.5,
        line_length = 8,
  ...
  working_visualisations = {
    {
      fadeout = true,
      animation = {
        filename = "__MoreScienceRefresh__/graphics/Refresh/arc-furnace/arc-furnace-hr-emission-1.png",
        priority = "high",
        size = { 320, 320 },
        shift = { 0, 0 },
        line_length = 8,
