  ...
  data:extend({
    {
      type = "technology",
      name = name,
      icon = "__MoreScienceRefresh__/graphics/technology/" .. name .. "-tech.png",
      icon_size = 128,
      effects =
      {
        {
...
addRocketScienceTechnology(rocketParts.power, {rocketTechName, "fission-reactor-equipment", "kovarex-enrichment-process"})
