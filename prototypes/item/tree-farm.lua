...
local handSaw =
{
  type = "item",
  name = "hand-saw",
  icon = "__MoreScienceRefresh__/graphics/icons/hand-saw.png",
  icon_size = 512,
  subgroup = "tool",
...
seedExtractor.icon = "__MoreScienceRefresh__/graphics/icons/" .. seedExtractor.name .. ".png"
...
woodPlantation.icon = "__MoreScienceRefresh__/graphics/icons/" .. woodPlantation.name .. ".png"
...
treeSeed.icon = "__MoreScienceRefresh__/graphics/icons/" .. treeSeed.name .. ".png"
