  ...
  data:extend({
    {
      ...
      icons = {
        {
          icon = "__MoreScienceRefresh__/graphics/icons/potion/set-02/potion-"
            .. numberToString(scienceNumber)
            .. ".png",
          icon_size = 32,
        },
        {
          icon = "__MoreScienceRefresh__/graphics/icons/potion/cork.png",
          icon_size = 32,
        },
      },
...
local function alterSciencePack(scienceName, scienceNumber)
  sciencePack = data.raw["item"][string.format(scienceName, "pack")]

  sciencePack.icon = nil
  sciencePack.icon_size = nil
  sciencePack.icons = {
    {
      icon = "__MoreScienceRefresh__/graphics/icons/potion/set-01/potion-" .. numberToString(scienceNumber) .. ".png",
      icon_size = 32,
    },
    {
      icon = "__MoreScienceRefresh__/graphics/icons/potion/cork.png",
  ...
  data.raw["item"][sciencePack.name] = util.table.deepcopy(sciencePack)

  LSlib.item.setSubgroup("item", sciencePack.name, "science-pack")
  LSlib.item.setOrderstring(
    "item",
    sciencePack.name,
    "z-MoreScience-" .. getFluidOrder(scienceName) .. "[" .. sciencePack.name .. "]"
  )
  ...
  data:extend({
    {
      ...
      icons = {
        {
          icon = "__MoreScienceRefresh__/graphics/icons/potion/set-01/potion-"
            .. numberToString(scienceNumber)
            .. ".png",
          icon_size = 32,
        },
